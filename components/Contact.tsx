...
export default function ContactAndReasons() {
  ...
  return (
    <div className="w-full font-sans text-gray-800 mt-10">
      {/* Bilingual Banner */}
      <div className="bg-[#99c82c] text-white rounded-t-[40px] mb-4 p-6 sm:p-8 max-w-4xl mx-auto flex flex-col items-start justify-between gap-6 relative -mt-6 z-10">
        <div className="flex items-start gap-4">
          <MessageSquare className="w-8 h-8 sm:w-10 sm:h-10 mt-1 flex-shrink-0" />
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight">
            We have bilingual staff!
          </h2>
        </div>
        <div className="flex flex-col sm:flex-row gap-6 w-full items-start sm:items-center">
      ...
      <div className="bg-white px-4 sm:px-6 py-12 sm:py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-[#2b303a]">Contact LifeFul today</h2>
          ...
          <form className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-left">
          ...
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6">Book a FREE 30-minute<br />consultation.</h3>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex flex-col gap-4 md:w-1/3">
            {reasons.map((reason, idx) => (
              <button
                ...
                className={`text-left text-sm font-semibold pb-2 border-b-2 transition-colors ${activeReason === idx
          ...
          <div className="md:w-2/3">
            <div className="relative mb-6">
              ...
              <div className="absolute -top-4 -right-2 bg-[#ee1585] text-white w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center text-xl sm:text-2xl font-bold shadow-lg">
