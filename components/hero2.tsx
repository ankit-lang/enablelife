...
export default function Hero2() {
  return (
    <div className="bg-white font-sans text-gray-800 mt-6 pb-12">
      {/* Navigation */}


      <main className="px-4 sm:px-6 max-w-4xl mx-auto mt-6">
        {/* Hero Header */}
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          {[
            ...
            >
              <div className="w-full max-w-[8rem] aspect-square rounded-xl overflow-hidden mb-2 bg-white/20">
